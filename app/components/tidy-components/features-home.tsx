...
export default function FeaturesHome() {
  ...
  return (
    <section className="relative">
      ...
      <div className="absolute inset-0 bg-orange-100 pointer-events-none mb-64 md:mb-80" aria-hidden="true"></div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12">
            <h2 className="h2 font-playfair-display text-slate-800 mb-4">Built with Transit in Mind</h2>
          ...
          <div className="px-24 mx-auto">
            ...
            <div className="flex justify-center gap-8 pb-12">
              ...
              >
                <div>
                  ...
                  <div className="md:text-lg leading-tight font-semibold text-slate-800">Real-time Monitoring</div>
                </div>
              </button>
              <button
              ...
              >
                <div>
                  ...
                  <div className="md:text-lg leading-tight font-semibold text-slate-800">Organizing Issues</div>
                </div>
              </button>
              {/* <button */}
              ...
              {/*       </svg> */}
              {/*     </div> */}
              {/*     <div className="md:text-lg leading-tight font-semibold text-slate-800">Reporting Issues</div> */}
              {/*   </div> */}
              {/* </button> */}
              {/* <button */}
              ...
              {/*       </svg> */}
              {/*     </div> */}
              {/*     <div className="md:text-lg leading-tight font-semibold text-slate-800">Email Summaries</div> */}
              {/*   </div> */}
              {/* </button> */}
            </div>
            ...
            <div className="transition-all">
              <div className="relative flex flex-col min-h-[600px]" data-aos="fade-up" ref={tabs}>
                {/* Item 1 */}
                <Transition
                  show={tab === 1}
                  className="w-full"
                ...
                >
                  <img src='/images/call-center.gif' alt='customer service workflow' />
                </Transition>
                {/* Item 2 */}
                <Transition
                  show={tab === 2}
                ...
                >
                  ...
                  <img src='/images/inbox.gif' alt='customer service workflow' />
                ...
                {/*   beforeEnter={() => heightFix()} */}
                {/* > */}
                {/*   <img src='/images/Email-updates.svg' width={540} height={405} alt='iek' /> */}
                {/* </Transition> */}
                ...
                {/*   beforeEnter={() => heightFix()} */}
                {/* > */}
                {/*   <img src='/images/Bus-map-illustration.png' width={540} height={405} alt='iek' /> */}
                {/* </Transition> */}
