      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-slate-200">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-playfair-display text-slate-800">Built for everyone in your agency</h2>
          </div>
          ...
          <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:items-start md:space-x-8 lg:space-x-16 xl:space-x-18 space-y-8 space-y-reverse md:space-y-0">
                ...
                <div className="relative flex flex-col" data-aos="fade-down" ref={tabs}>
                  ...
                  >
                    <div className="relative inline-flex flex-col">
                      <img src='/images/planning-documentation.svg' width={540} height={405} alt='iek' />
                    </div>
                  </Transition>
                  {/* Item 2 */}
                  <Transition
                  ...
                  >
                    <div className="relative inline-flex flex-col">
                      <img src='/images/issue-creation.png' width={540} height={405} alt='iek' />
                    </div>
                  </Transition>
                  {/* Item 3 */}
                  <Transition
                  ...
                  >
                    <div className="relative inline-flex flex-col">
                      <img src='/images/transit-executives.svg' width={540} height={405} alt='iek' />
                    </div>
                  </Transition>
                </div>
              </div>
            ...
            <div className="md:w-7/12 lg:w-1/2" data-aos="fade-up">
              <div className="mb-8 text-center md:text-left">
                <h3 className="h3 text-slate-800 font-playfair-display mb-3">TransitChat for different departments</h3>
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  ...
                  <div>
                    <div className="text-slate-800 font-medium mb-1">Planning & Scheduling</div>
                    <div className="text-slate-500">View what transit riders are complaining about and schedule out solutions with coworkers with chat and mapping tools. No more forgetting to forward emails.</div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    <div className="text-slate-800 font-medium mb-1">Customer Service</div>
                    <div className="text-slate-500">Simple tools to map vehicle locations and on-time performance in real-time. Make the most with one screen by tracking vehicles and submitting complaints.</div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    <div className="text-slate-800 font-medium mb-1">Transit Executives</div>
                    <div className="text-slate-500">Stay up to date with what people are working on and know what your riders are saying with a simple digest in your mailbox every mornning. No more meetings.</div>
                  </div>
                </button>
              </div>
            </div>
