        ...
        <div className="py-12 md:py-20">
          <div className="relative max-w-3xl mx-auto text-center">
            ...
            <div className="relative">
              <h2 className="h2 font-playfair-display text-slate-800 mb-4">Say goodbye to chasing after emails and manual <span className="text-emerald-500">documentation</span>.</h2>
              <p className="text-xl text-slate-500 mb-8">TransitChat offers the premier solution for making it simple to funnel customer complaints into schedule planning and federal documentation. Break down the communication silos in your agency today.</p>
              <div>
                <Link className="btn text-white bg-blue-600 hover:bg-blue-700 group"
                  to="/request-demo">
                  Request Demo
                  <ArrowRight />
                </Link>
