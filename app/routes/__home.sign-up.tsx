...
import { StripePricingTable } from "~/config/pricing";
        ...
        <div className="min-h-screen h-full flex flex-col justify-center">
          <div className="px-5 sm:px-6 py-8">
            <div className="w-full max-w-md mx-auto">
              {/* Site branding */}
              <h1 className="h2 font-playfair-display text-slate-800 pt-24 mb-2">
                Signup for TransitChat
              </h1>
                  ...
                  <div className="space-y-4">
                    ...
                    <Select name="country">
                      ...
                      <SelectContent>
                        {countries.map((el, key) => (
                          <SelectItem key={key} value={el.name}>
                            {el.name}
                          </SelectItem>
                        ))}
                      </SelectContent>
                    ...
                    <div>
                      <label
                        ...
                        htmlFor="gtfsUrl"
                      >
                        GTFS Url<span className="text-rose-500">*</span>
                      </label>
                      <Input
                        name="gtfsUrl"
                        className="form-input py-2 w-full"
